...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scorbot-msg:<TrajectoryPoint> is deprecated: use scorbot-msg:TrajectoryPoint instead.")))

(cl:ensure-generic-function 'positions-val :lambda-list '(m))
(cl:defmethod positions-val ((m <TrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scorbot-msg:positions-val is deprecated.  Use scorbot-msg:positions instead.")
  (positions m))
