...
class Metaclass_Control(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('universal_teleop_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'universal_teleop_msgs.msg.Control')
            logger.debug(
...
class Control(metaclass=Metaclass_Control):
    ...
    def __init__(self, **kwargs):
        ...
        self.control = kwargs.get('control', str())
    ...
    def control(self, value):
        if __debug__:
            assert \
                ...
                "The 'control' field must be of type 'str'"
        self._control = value
