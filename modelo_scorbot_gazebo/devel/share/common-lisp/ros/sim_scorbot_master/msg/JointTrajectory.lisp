...
(cl:defmethod cl:initialize-instance :after ((m <JointTrajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTrajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sim_scorbot_master-msg:<JointTrajectory> is deprecated: use sim_scorbot_master-msg:JointTrajectory instead.")))
...
(cl:defmethod points-val ((m <JointTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sim_scorbot_master-msg:points-val is deprecated.  Use sim_scorbot_master-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTrajectory>)))
  ...
  "sim_scorbot_master/JointTrajectory")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTrajectory)))
  "Returns string type for a message object of type 'JointTrajectory"
  "sim_scorbot_master/JointTrajectory")
