...
{
  new (message_memory) scorbot_msgs::msg::JointTrajectory(_init);
}

void JointTrajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<scorbot_msgs::msg::JointTrajectory *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointTrajectory_message_member_array[2] = {
  {
    ...
    offsetof(scorbot_msgs::msg::JointTrajectory, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scorbot_msgs::msg::JointTrajectory, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointTrajectory_message_members = {
  ...
  2,  // number of fields
  sizeof(scorbot_msgs::msg::JointTrajectory),
...
{
  return &::scorbot_msgs::msg::rosidl_typesupport_introspection_cpp::JointTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scorbot_msgs, msg, JointTrajectory)() {
  return &::scorbot_msgs::msg::rosidl_typesupport_introspection_cpp::JointTrajectory_message_type_support_handle;
}
