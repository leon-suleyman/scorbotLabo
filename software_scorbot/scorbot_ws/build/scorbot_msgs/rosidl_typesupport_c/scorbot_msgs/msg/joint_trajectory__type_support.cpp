...
static const _JointTrajectory_type_support_symbol_names_t _JointTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scorbot_msgs, msg, JointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scorbot_msgs, msg, JointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, scorbot_msgs, msg, JointTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, scorbot_msgs, msg, JointTrajectory)() {
  return &::scorbot_msgs::msg::rosidl_typesupport_c::JointTrajectory_message_type_support_handle;
}
