...
{
  new (message_memory) scorbot_msgs::msg::TrajectoryPoint(_init);
}

void TrajectoryPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<scorbot_msgs::msg::TrajectoryPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryPoint_message_member_array[1] = {
  {
    "positions",  // name
    ...
    offsetof(scorbot_msgs::msg::TrajectoryPoint, positions),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryPoint_message_members = {
  ...
  1,  // number of fields
  sizeof(scorbot_msgs::msg::TrajectoryPoint),
...
{
  return &::scorbot_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scorbot_msgs, msg, TrajectoryPoint)() {
  return &::scorbot_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
