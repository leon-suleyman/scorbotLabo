...
scorbot_msgs__msg__JointTrajectory__init(scorbot_msgs__msg__JointTrajectory * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    scorbot_msgs__msg__JointTrajectory__fini(msg);
    return false;
  }
  // points
...
scorbot_msgs__msg__JointTrajectory__create()
{
  ...
  scorbot_msgs__msg__JointTrajectory * msg = (scorbot_msgs__msg__JointTrajectory *)allocator.allocate(sizeof(scorbot_msgs__msg__JointTrajectory), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(scorbot_msgs__msg__JointTrajectory));
  bool success = scorbot_msgs__msg__JointTrajectory__init(msg);
  if (!success) {
...
scorbot_msgs__msg__JointTrajectory__Sequence__init(scorbot_msgs__msg__JointTrajectory__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  scorbot_msgs__msg__JointTrajectory * data = NULL;

  if (size) {
    data = (scorbot_msgs__msg__JointTrajectory *)allocator.zero_allocate(size, sizeof(scorbot_msgs__msg__JointTrajectory), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = scorbot_msgs__msg__JointTrajectory__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        scorbot_msgs__msg__JointTrajectory__fini(&data[i - 1]);
      }
...
scorbot_msgs__msg__JointTrajectory__Sequence__fini(scorbot_msgs__msg__JointTrajectory__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      scorbot_msgs__msg__JointTrajectory__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  scorbot_msgs__msg__JointTrajectory__Sequence * array = (scorbot_msgs__msg__JointTrajectory__Sequence *)allocator.allocate(sizeof(scorbot_msgs__msg__JointTrajectory__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = scorbot_msgs__msg__JointTrajectory__Sequence__init(array, size);
  if (!success) {
...
scorbot_msgs__msg__JointTrajectory__Sequence__destroy(scorbot_msgs__msg__JointTrajectory__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    scorbot_msgs__msg__JointTrajectory__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
scorbot_msgs__msg__JointTrajectory__Sequence__are_equal(const scorbot_msgs__msg__JointTrajectory__Sequence * lhs, const scorbot_msgs__msg__JointTrajectory__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!scorbot_msgs__msg__JointTrajectory__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  scorbot_msgs__msg__JointTrajectory__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(scorbot_msgs__msg__JointTrajectory);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    scorbot_msgs__msg__JointTrajectory * data =
      (scorbot_msgs__msg__JointTrajectory *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!scorbot_msgs__msg__JointTrajectory__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          scorbot_msgs__msg__JointTrajectory__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!scorbot_msgs__msg__JointTrajectory__copy(
