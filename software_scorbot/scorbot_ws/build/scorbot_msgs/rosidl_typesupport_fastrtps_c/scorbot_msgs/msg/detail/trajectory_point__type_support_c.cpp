...
#include "scorbot_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryPoint__ros_msg_type = scorbot_msgs__msg__TrajectoryPoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scorbot_msgs__msg__TrajectoryPoint;
    is_plain =
      (
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_scorbot_msgs__msg__TrajectoryPoint(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scorbot_msgs, msg, TrajectoryPoint)() {
