...
#include "scorbot_msgs/msg/detail/joint_trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _JointTrajectory__ros_msg_type = scorbot_msgs__msg__JointTrajectory;
  ...
  void * untyped_ros_message)
{
  ...
  _JointTrajectory__ros_msg_type * ros_message = static_cast<_JointTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scorbot_msgs__msg__JointTrajectory;
    is_plain =
      (
...
static size_t _JointTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_scorbot_msgs__msg__JointTrajectory(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scorbot_msgs, msg, JointTrajectory)() {
