...
#include "scorbot_msgs/msg/detail/joint_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scorbot_msgs::msg::JointTrajectory;
    is_plain =
      (
...
{
  return &scorbot_msgs::msg::typesupport_fastrtps_cpp::_JointTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scorbot_msgs, msg, JointTrajectory)() {
  return &scorbot_msgs::msg::typesupport_fastrtps_cpp::_JointTrajectory__handle;
}
