...
#include "scorbot_msgs/msg/detail/joint_velocities__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scorbot_msgs::msg::JointVelocities;
    is_plain =
      (
...
static size_t _JointVelocities__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointVelocities(full_bounded, is_plain, 0);
...
{
  return &scorbot_msgs::msg::typesupport_fastrtps_cpp::_JointVelocities__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scorbot_msgs, msg, JointVelocities)() {
  return &scorbot_msgs::msg::typesupport_fastrtps_cpp::_JointVelocities__handle;
}
