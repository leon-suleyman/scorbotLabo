...
#include "scorbot_msgs/msg/detail/joint_trajectory__rosidl_typesupport_microxrcedds_cpp.hpp"
...
cdr_serialize(
  const scorbot_msgs::msg::JointTrajectory & ros_message,
  ucdrBuffer * cdr)
{
  (void) ros_message;
  (void) cdr;
  ...
  // Member: points
  {
    ...
    rv = ucdr_serialize_sequence_int32_t(cdr, &ros_message.points[0], size);
  }
...
cdr_deserialize(
  ucdrBuffer * cdr,
  scorbot_msgs::msg::JointTrajectory & ros_message)
{
  (void) cdr;
  (void) ros_message;
  bool rv = false;
  ...
  // Member: points
  {
    ...
    ros_message.points.resize(capacity);
    rv = ucdr_deserialize_sequence_int32_t(cdr, &ros_message.points[0], capacity, &size);
    if (rv) {
...
{
  auto typed_message =
    static_cast<const scorbot_msgs::msg::JointTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scorbot_msgs::msg::JointTrajectory *>(
    untyped_ros_message);
...
get_message_type_support_handle<scorbot_msgs::msg::JointTrajectory>()
{
  return &scorbot_msgs::msg::typesupport_microxrcedds_cpp::_JointTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, scorbot_msgs, msg, JointTrajectory)() {
  return &scorbot_msgs::msg::typesupport_microxrcedds_cpp::_JointTrajectory__handle;
}
