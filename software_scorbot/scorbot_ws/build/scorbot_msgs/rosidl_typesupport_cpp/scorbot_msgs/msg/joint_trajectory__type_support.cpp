...
static const _JointTrajectory_type_support_symbol_names_t _JointTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scorbot_msgs, msg, JointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scorbot_msgs, msg, JointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, scorbot_msgs, msg, JointTrajectory)),
  }
};
...
{
  return &::scorbot_msgs::msg::rosidl_typesupport_cpp::JointTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, scorbot_msgs, msg, JointTrajectory)() {
  return get_message_type_support_handle<scorbot_msgs::msg::JointTrajectory>();
}
