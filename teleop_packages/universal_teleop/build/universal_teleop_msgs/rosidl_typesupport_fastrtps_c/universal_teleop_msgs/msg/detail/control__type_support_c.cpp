...
#include "universal_teleop_msgs/msg/detail/control__rosidl_typesupport_fastrtps_c.h"
...
#include "universal_teleop_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_universal_teleop_msgs
...
using _Control__ros_msg_type = universal_teleop_msgs__msg__Control;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_universal_teleop_msgs
size_t get_serialized_size_universal_teleop_msgs__msg__Control(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Control__ros_msg_type * ros_message = static_cast<const _Control__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Control__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_universal_teleop_msgs__msg__Control(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_universal_teleop_msgs
size_t max_serialized_size_universal_teleop_msgs__msg__Control(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = universal_teleop_msgs__msg__Control;
    is_plain =
      (
...
static size_t _Control__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_universal_teleop_msgs__msg__Control(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, universal_teleop_msgs, msg, Control)() {
