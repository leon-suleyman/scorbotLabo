...
#include "universal_teleop_msgs/msg/detail/event__rosidl_typesupport_fastrtps_c.h"
...
using _Event__ros_msg_type = universal_teleop_msgs__msg__Event;
...
size_t get_serialized_size_universal_teleop_msgs__msg__Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Event__ros_msg_type * ros_message = static_cast<const _Event__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_universal_teleop_msgs__msg__Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_universal_teleop_msgs
size_t max_serialized_size_universal_teleop_msgs__msg__Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = universal_teleop_msgs__msg__Event;
    is_plain =
      (
...
static size_t _Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_universal_teleop_msgs__msg__Event(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, universal_teleop_msgs, msg, Event)() {
